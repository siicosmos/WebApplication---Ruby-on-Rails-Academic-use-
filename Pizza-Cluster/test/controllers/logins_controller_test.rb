...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { E-mail: @login.E-mail, Password: @login.Password } }
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { E-mail: @login.E-mail, Password: @login.Password } }
